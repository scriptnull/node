...
$REQEXEC_BIN_PATH ="C:\Users\ContainerAdministrator\Shippable\reqExec\x86_64\WindowsServer_2016\dist\main\main"
...
Function boot_reqProc() {
  ...
  $install_git = "docker exec $REQPROC_CONTAINER_NAME powershell choco install -y git"
  Write-Output "Installing git"
  iex "$install_git"
